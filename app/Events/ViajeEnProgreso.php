...
class ViajeEnProgreso implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            'viaje' => [
                ...
                'fecha_inicio' => $this->viaje->fecha_inicio?->toISOString(),
            ],
            'conductor' => [
                'id' => $this->conductor->id,
                'name' => $this->conductor->name,
                'telefono' => $this->conductor->telefono,
                'ubicacion_actual' => $this->conductor->ubicacion_actual,
            ],
